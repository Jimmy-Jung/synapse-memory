...
저장소 위치는 GUI에서 선택합니다. Obsidian 앱에 이미 등록된 Vault,
iCloud/Documents 아래 기존 Vault, 새 `iCloud/SynapseVault` 추천 위치,
로컬 `Documents/SynapseVault`, 직접 선택 옵션을 함께 보여줍니다.
...
W9 ✓ 비개발자 온보딩 (v0.6.2) — 더블클릭 installer preview + iCloud vault 추천 + doctor --fix

692 tests passed · v0.6.2
```
