...
설치 파일은 아래 링크에서 받아줘.
https://github.com/Jimmy-Jung/synapse-memory/releases/download/v1.16.1/SynapseMemory-v1.16.1-macos-installer.zip
...
1. [SynapseMemory-v1.16.1-macos-installer.zip][installer-zip]을 다운로드합니다.
...
[installer-zip]: https://github.com/Jimmy-Jung/synapse-memory/releases/download/v1.16.1/SynapseMemory-v1.16.1-macos-installer.zip
