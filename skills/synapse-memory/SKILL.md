...
3. [docs/getting-started.md](https://github.com/example-org/synapse-memory/blob/main/docs/getting-started.md)
4. [docs/commands.md](https://github.com/example-org/synapse-memory/blob/main/docs/commands.md) — 전체 CLI 옵션
5. [GitHub Issues](https://github.com/example-org/synapse-memory/issues)
