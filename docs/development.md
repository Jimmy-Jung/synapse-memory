...
## 어떤 작업을 하려면 어디부터 보면 되나

| 작업 | 가는 곳 |
|---|---|
| "처음 개발 환경 세팅" | [§ 개발 환경](#개발-환경) |
...
| "Redaction 패턴 추가" | [§ Redaction 패턴 추가](#redaction-패턴-추가) |
| "Card schema 바꾸기" | [§ Card schema 변경](#card-schema-변경) |
| "apfel / Claude Code / 임베딩 디버깅" | [§ 디버깅](#디버깅) |
| "비용 확인 / 절감" | [§ 비용 확인](#비용-확인) |
| "문서 갱신 기준" | [§ 문서 갱신 기준](#문서-갱신-기준) |
| "PR 보내기 전 체크리스트" | [§ 기여 전 체크리스트](#기여-전-체크리스트) |
