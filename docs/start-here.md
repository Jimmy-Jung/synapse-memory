...
| 명령 | 하는 일 |
| --- | --- |
| `/sm:doctor` | Obsidian, Claude Code/Codex, 로컬 AI 도구, 설정 상태를 확인합니다. |
| `/sm:daily` | 새 노트와 대화 기록을 모으고 요약 카드와 Profile 후보를 만듭니다. |
| `/sm:ask` | 만들어진 카드에서 관련 자료를 찾아 답합니다. |
